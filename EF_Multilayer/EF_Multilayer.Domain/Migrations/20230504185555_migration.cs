    ...
    public partial class migration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SkillId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TechName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    WorkExp = table.Column<decimal>(type: "decimal(18,2)", maxLength: 50, nullable: true),
                    Rating = table.Column<decimal>(type: "decimal(18,2)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SystemDetails", x => x.DetailId);
                    table.ForeignKey(
